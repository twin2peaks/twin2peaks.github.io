 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vt extends sr{constructor(){super("facebook.com")}static credential(e){return xt._fromParams({providerId:vt.PROVIDER_ID,signInMethod:vt.FACEBOOK_SIGN_IN_METHOD,accessToken:e})}static credentialFromResult(e){return vt.credentialFromTaggedObject(e)}static credentialFromError(e){return vt.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e||!("oauthAccessToken"in e)||!e.oauthAccessToken)return null;try{return vt.credential(e.oauthAccessToken)}catch{return null}}}vt.FACEBOOK_SIGN_IN_METHOD="facebook.com";vt.PROVIDER_ID="facebook.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class pt extends sr{constructor(){super("google.com"),this.addScope("profile")}static credential(e,t){return xt._fromParams({providerId:pt.PROVIDER_ID,signInMethod:pt.GOOGLE_SIGN_IN_METHOD,idToken:e,accessToken:t})}static credentialFromResult(e){return pt.credentialFromTaggedObject(e)}static credentialFromError(e){return pt.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e)return null;const{oauthIdToken:t,oauthAccessToken:s}=e;if(!t&&!s)return null;try{return pt.credential(t,s)}catch{return null}}}pt.GOOGLE_SIGN_IN_METHOD="google.com";pt.PROVIDER_ID="google.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gt extends sr{constructor(){super("github.com")}static credential(e){return xt._fromParams({providerId:gt.PROVIDER_ID,signInMethod:gt.GITHUB_SIGN_IN_METHOD,accessToken:e})}static credentialFromResult(e){return gt.credentialFromTaggedObject(e)}static credentialFromError(e){return gt.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e||!("oauthAccessToken"in e)||!e.oauthAccessToken)return null;try{return gt.credential(e.oauthAccessToken)}catch{return null}}}gt.GITHUB_SIGN_IN_METHOD="github.com";gt.PROVIDER_ID="github.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class mt extends sr{constructor(){super("twitter.com")}static credential(e,t){return xt._fromParams({providerId:mt.PROVIDER_ID,signInMethod:mt.TWITTER_SIGN_IN_METHOD,oauthToken:e,oauthTokenSecret:t})}static credentialFromResult(e){return mt.credentialFromTaggedObject(e)}static credentialFromError(e){return mt.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e)return null;const{oauthAccessToken:t,oauthTokenSecret:s}=e;if(!t||!s)return null;try{return mt.credential(t,s)}catch{return null}}}mt.TWITTER_SIGN_IN_METHOD="twitter.com";mt.PROVIDER_ID="twitter.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class kt{constructor(e){this.user=e.user,this.providerId=e.providerId,this._tokenResponse=e._tokenResponse,this.operationType=e.operationType}static async _fromIdTokenResponse(e,t,s,n=!1){const i=await Ye._fromIdTokenResponse(e,s,n),a=Es(s);return new kt({user:i,providerId:a,_tokenResponse:s,operationType:t})}static async _forOperation(e,t,s){await e._updateTokensIfNecessary(s,!0);const n=Es(s);return new kt({user:e,providerId:n,_tokenResponse:s,operationType:t})}}function Es(r){return r.providerId?r.providerId:"phoneNumber"in r?"phone":null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Kl(r,e,t=!1){const{auth:s}=r;if(Ge(s.app))return Promise.reject(at(s));const n="reauthenticate";try{const i=await Yt(r,Tn(s,n,e,r),t);G(i.idToken,s,"internal-error");const a=qr(i.idToken);G(a,s,"internal-error");const{sub:o}=a;return G(r.uid===o,s,"user-mismatch"),kt._forOperation(r,n,i)}catch(i){throw(i==null?void 0:i.code)==="auth/user-not-found"&&Je(s,"user-mismatch"),i}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Pn(r,e,t=!1){if(Ge(r.app))return Promise.reject(at(r));const s="signIn",n=await Tn(r,s,e),i=await kt._fromIdTokenResponse(r,s,n);return t||await r._updateCurrentUser(i.user),i}async function Yl(r,e){return Pn(It(r),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function xn(r){const e=It(r);e._getPasswordPolicyInternal()&&await e._updatePasswordPolicy()}async function Jl(r,e,t){const s=It(r);await pr(s,{requestType:"PASSWORD_RESET",email:e,clientType:"CLIENT_TYPE_WEB"},"getOobCode",Bl)}async function Zl(r,e,t){if(Ge(r.app))return Promise.reject(at(r));const s=It(r),a=await pr(s,{returnSecureToken:!0,email:e,password:t,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",ql).catch(l=>{throw l.code==="auth/password-does-not-meet-requirements"&&xn(r),l}),o=await kt._fromIdTokenResponse(s,"signIn",a);return await s._updateCurrentUser(o.user),o}function Ql(r,e,t){return Ge(r.app)?Promise.reject(at(r)):Yl(ct(r),Ut.credential(e,t)).catch(async s=>{throw s.code==="auth/password-does-not-meet-requirements"&&xn(r),s})}function Xl(r,e,t,s){return ct(r).onIdTokenChanged(e,t,s)}function ec(r,e,t){return ct(r).beforeAuthStateChanged(e,t)}function tc(r,e,t,s){return ct(r).onAuthStateChanged(e,t,s)}function rc(r){return ct(r).signOut()}const mr="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const dd=5*60,ud=Ks("authIdTokenMaxAge")||dd;let Rs=null;const hd=r=>async e=>{const t=e&&await e.getIdTokenResult(),s=t&&(new Date().getTime()-Date.parse(t.issuedAtTime))/1e3;if(s&&s>ud)return;const n=t==null?void 0:t.token;Rs!==n&&(Rs=n,await fetch(r,{method:n?"POST":"DELETE",headers:n?{Authorization:`Bearer ${n}`}:{}}))};function fd(r=Uo()){const e=Qs(r,"auth");if(e.isInitialized())return e.getImmediate();const t=Rl(r,{popupRedirectResolver:ad,persistence:[mc,ic,Cn]}),s=Ks("authTokenSyncURL");if(s&&typeof isSecureContext=="boolean"&&isSecureContext){const i=new URL(s,location.origin);if(location.origin===i.origin){const a=hd(i.toString());ec(t,a,()=>a(t.currentUser)),Xl(t,o=>a(o))}}const n=ba("auth");return n&&Ml(t,`http://${n}`),t}function vd(){var r;return((r=document.getElementsByTagName("head"))==null?void 0:r[0])??document}Tl({loadJS(r){return new Promise((e,t)=>{const s=document.createElement("script");s.setAttribute("src",r),s.onload=e,s.onerror=n=>{const i=Xe("internal-error");i.customData=n,t(i)},s.type="text/javascript",s.charset="UTF-8",vd().appendChild(s)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});cd("Browser");const pd={apiKey:"AIzaSyDy5zDOy9WuqAoiZpacrojs0qJlSVdb9c8",authDomain:"elastotool-authentification.firebaseapp.com",projectId:"elastotool-authentification",storageBucket:"elastotool-authentification.firebasestorage.app",messagingSenderId:"312737503016",appId:"1:312737503016:web:fa5179d68617b63287621d"},gd=Xs(pd),qt=fd(gd);var md=T('<div class="content-wrapper svelte-1mt858d"><!></div>');function Et(r,e){E(e,"backLabel",3,"BACK"),E(e,"actionLabel",3,""),Jn(r,{class:"content-container",style:"background-color: #f4f7f6; padding: 2rem; margin:0",children:(t,s)=>{var n=md(),i=f(n);Le(i,{light:!0,children:(a,o)=>{var l=ze(),u=q(l);Yn(u,()=>e.children),v(a,l)},$$slots:{default:!0}}),h(n),v(t,n)},$$slots:{default:!0}})}var _d=T('<h1 class="page-title svelte-k0pwcb">Dashboard</h1> <p class="page-subtitle svelte-k0pwcb">Overview of your business metrics</p>',1),bd=T('<p class="metric-label svelte-k0pwcb">Total Orders</p> <p class="metric-value svelte-k0pwcb">156</p> <p class="metric-change positive svelte-k0pwcb">+12% from last month</p>',1),yd=T('<p class="metric-label svelte-k0pwcb">Active Quotes</p> <p class="metric-value svelte-k0pwcb">23</p> <p class="metric-change positive svelte-k0pwcb">+5% from last month</p>',1),wd=T('<p class="metric-label svelte-k0pwcb">Pending Requests</p> <p class="metric-value svelte-k0pwcb">8</p> <p class="metric-change negative svelte-k0pwcb">-3% from last month</p>',1),Id=T('<p class="metric-label svelte-k0pwcb">Revenue</p> <p class="metric-value svelte-k0pwcb">$248,500</p> <p class="metric-change positive svelte-k0pwcb">+18% from last month</p>',1),Ed=T("<!> <!> <!> <!>",1),Td=T('<h3 class="section-title svelte-k0pwcb">Recent Activity</h3> <ul class="activity-list svelte-k0pwcb"><li class="svelte-k0pwcb">Order #27051941 shipped to TIMBER DEPOT</li> <li class="svelte-k0pwcb">New quote requested by LUMBER COMPANY</li> <li class="svelte-k0pwcb">Payment received for Order #27041938</li> <li class="svelte-k0pwcb">Product catalog updated with 12 new items</li></ul>',1),Pd=T('<h3 class="section-title svelte-k0pwcb">Quick Actions</h3> <div class="quick-actions svelte-k0pwcb"><!> <!> <!></div>',1),xd=T("<!> <!>",1),kd=T("<!> <!> <!>",1);function Os(r){Et(r,{backLabel:"",actionLabel:"",children:(e,t)=>{var s=kd(),n=q(s);Se(n,{children:(o,l)=>{ee(o,{lg:16,children:(u,m)=>{var p=_d();W(2),v(u,p)},$$slots:{default:!0}})},$$slots:{default:!0}});var i=g(n,2);Se(i,{children:(o,l)=>{var u=Ed(),m=q(u);ee(m,{lg:4,md:4,sm:4,children:(y,C)=>{Le(y,{light:!0,class:"metric-tile",children:(I,w)=>{var S=bd();W(4),v(I,S)},$$slots:{default:!0}})},$$slots:{default:!0}});var p=g(m,2);ee(p,{lg:4,md:4,sm:4,children:(y,C)=>{Le(y,{light:!0,class:"metric-tile",children:(I,w)=>{var S=yd();W(4),v(I,S)},$$slots:{default:!0}})},$$slots:{default:!0}});var d=g(p,2);ee(d,{lg:4,md:4,sm:4,children:(y,C)=>{Le(y,{light:!0,class:"metric-tile",children:(I,w)=>{var S=wd();W(4),v(I,S)},$$slots:{default:!0}})},$$slots:{default:!0}});var _=g(d,2);ee(_,{lg:4,md:4,sm:4,children:(y,C)=>{Le(y,{light:!0,class:"metric-tile",children:(I,w)=>{var S=Id();W(4),v(I,S)},$$slots:{default:!0}})},$$slots:{default:!0}}),v(o,u)},$$slots:{default:!0}});var a=g(i,2);Se(a,{children:(o,l)=>{var u=xd(),m=q(u);ee(m,{lg:8,md:8,sm:4,children:(d,_)=>{Le(d,{light:!0,children:(y,C)=>{var I=Td();W(2),v(y,I)},$$slots:{default:!0}})},$$slots:{default:!0}});var p=g(m,2);ee(p,{lg:8,md:8,sm:4,children:(d,_)=>{Le(d,{light:!0,children:(y,C)=>{var I=Pd(),w=g(q(I),2),S=f(w);Ft(S,{children:(b,j)=>{W();var V=ce("Create New Quote");v(b,V)},$$slots:{default:!0}});var M=g(S,2);Ft(M,{children:(b,j)=>{W();var V=ce("Add Product");v(b,V)},$$slots:{default:!0}});var O=g(M,2);Ft(O,{children:(b,j)=>{W();var V=ce("View Reports");v(b,V)},$$slots:{default:!0}}),h(w),v(y,I)},$$slots:{default:!0}})},$$slots:{default:!0}}),v(o,u)},$$slots:{default:!0}}),v(e,s)},$$slots:{default:!0}})}var Ad=T('<h1 class="page-title svelte-1cf4os2">Chats</h1> <p class="page-subtitle svelte-1cf4os2">Customer conversations</p>',1),Sd=T('<div><div class="chat-avatar svelte-1cf4os2"> </div> <div class="chat-info svelte-1cf4os2"><div class="chat-header svelte-1cf4os2"><span class="chat-name svelte-1cf4os2"> </span> <span class="chat-time svelte-1cf4os2"> </span></div> <div class="chat-preview svelte-1cf4os2"><span class="chat-message svelte-1cf4os2"> </span> <!></div></div></div>'),Cd=T('<div class="chat-list svelte-1cf4os2"><div class="search-wrapper svelte-1cf4os2"><!></div> <!></div>'),$d=T('<div class="chat-window-header svelte-1cf4os2"><div class="chat-avatar large svelte-1cf4os2">L</div> <div><p class="chat-window-name svelte-1cf4os2">LUMBER COMPANY</p> <p class="chat-window-status svelte-1cf4os2">Online</p></div></div> <div class="chat-messages svelte-1cf4os2"><div class="message received svelte-1cf4os2"><p class="svelte-1cf4os2">Hi, I wanted to follow up on our recent order.</p> <span class="message-time svelte-1cf4os2">10:28 AM</span></div> <div class="message sent svelte-1cf4os2"><p class="svelte-1cf4os2">Of course! Order #27051941 is currently being prepared for shipment.</p> <span class="message-time svelte-1cf4os2">10:30 AM</span></div> <div class="message received svelte-1cf4os2"><p class="svelte-1cf4os2">Thanks for the quick response!</p> <span class="message-time svelte-1cf4os2">10:32 AM</span></div></div> <div class="chat-input svelte-1cf4os2"><input type="text" placeholder="Type a message..." class="svelte-1cf4os2"/></div>',1),Rd=T("<!> <!>",1),Od=T("<!> <!>",1);function Md(r){const e=[{id:1,name:"LUMBER COMPANY",lastMessage:"Thanks for the quick response!",time:"10:32 AM",unread:2},{id:2,name:"TIMBER DEPOT",lastMessage:"When can we expect the shipment?",time:"Yesterday",unread:0},{id:3,name:"WOODWORKS INC",lastMessage:"Please send the updated quote",time:"Yesterday",unread:1},{id:4,name:"FOREST SUPPLIES",lastMessage:"Order confirmed, thank you!",time:"2 days ago",unread:0},{id:5,name:"PINE TRADERS",lastMessage:"Can you match this price?",time:"3 days ago",unread:0}];Et(r,{backLabel:"",actionLabel:"New Chat",children:(t,s)=>{var n=Od(),i=q(n);Se(i,{children:(o,l)=>{ee(o,{lg:16,children:(u,m)=>{var p=Ad();W(2),v(u,p)},$$slots:{default:!0}})},$$slots:{default:!0}});var a=g(i,2);Se(a,{children:(o,l)=>{var u=Rd(),m=q(u);ee(m,{lg:5,md:8,sm:4,children:(d,_)=>{var y=Cd(),C=f(y),I=f(C);Vr(I,{placeholder:"Search conversations..."}),h(C);var w=g(C,2);At(w,1,()=>e,Lt,(S,M)=>{var O=Sd();let b;var j=f(O),V=f(j,!0);h(j);var H=g(j,2),A=f(H),k=f(A),B=f(k,!0);h(k);var U=g(k,2),F=f(U,!0);h(U),h(A);var L=g(A,2),x=f(L),z=f(x,!0);h(x);var fe=g(x,2);{var ye=J=>{Zt(J,{type:"blue",size:"sm",children:(re,le)=>{W();var de=ce();R(()=>P(de,c(M).unread)),v(re,de)},$$slots:{default:!0}})};N(fe,J=>{c(M).unread>0&&J(ye)})}h(L),h(H),h(O),R((J,re)=>{b=Ae(O,1,"chat-item svelte-1cf4os2",null,b,J),P(V,re),P(B,c(M).name),P(F,c(M).time),P(z,c(M).lastMessage)},[()=>({unread:c(M).unread>0}),()=>c(M).name.charAt(0)],ae),v(S,O)}),h(y),v(d,y)},$$slots:{default:!0}});var p=g(m,2);ee(p,{lg:11,md:8,sm:4,children:(d,_)=>{Le(d,{class:"chat-window",children:(y,C)=>{var I=$d();W(4),v(y,I)},$$slots:{default:!0}})},$$slots:{default:!0}}),v(o,u)},$$slots:{default:!0}}),v(t,n)},$$slots:{default:!0}})}var Dd=T('<dt class="svelte-1nmltxe">Lieferdatum</dt> <dd class="svelte-1nmltxe"> </dd>',1),Nd=T('<dt class="svelte-1nmltxe">Führungslager</dt> <dd class="svelte-1nmltxe"> </dd>',1),Ld=T('<dt class="svelte-1nmltxe">Festpunktlager</dt> <dd class="svelte-1nmltxe"> </dd>',1),Ud=T('<span class="chip svelte-1nmltxe"> </span>'),Hd=T('<section class="detail-section full-width svelte-1nmltxe"><h4 class="svelte-1nmltxe">Zusätzliche Anmerkungen</h4> <p class="notes svelte-1nmltxe"> </p></section>'),Bd=T('<div class="detail-grid svelte-1nmltxe"><section class="detail-section svelte-1nmltxe"><h4 class="svelte-1nmltxe">Allgemeine Informationen</h4> <dl class="svelte-1nmltxe"><dt class="svelte-1nmltxe">Anfrage-ID</dt> <dd class="svelte-1nmltxe"> </dd> <dt class="svelte-1nmltxe">Erstellt am</dt> <dd class="svelte-1nmltxe"> </dd></dl></section> <section class="detail-section svelte-1nmltxe"><h4 class="svelte-1nmltxe">Kontaktdaten</h4> <dl class="svelte-1nmltxe"><dt class="svelte-1nmltxe">Name</dt> <dd class="svelte-1nmltxe"> </dd> <dt class="svelte-1nmltxe">E-Mail</dt> <dd class="svelte-1nmltxe"> </dd> <dt class="svelte-1nmltxe">Firma</dt> <dd class="svelte-1nmltxe"> </dd> <dt class="svelte-1nmltxe">Rolle</dt> <dd class="svelte-1nmltxe"> </dd></dl></section> <section class="detail-section svelte-1nmltxe"><h4 class="svelte-1nmltxe">Projektinformationen</h4> <dl class="svelte-1nmltxe"><dt class="svelte-1nmltxe">Projektname</dt> <dd class="svelte-1nmltxe"> </dd> <dt class="svelte-1nmltxe">PLZ</dt> <dd class="svelte-1nmltxe"> </dd> <dt class="svelte-1nmltxe">Projektphase</dt> <dd class="svelte-1nmltxe"> </dd> <dt class="svelte-1nmltxe">Anfragetyp</dt> <dd class="svelte-1nmltxe"> </dd> <dt class="svelte-1nmltxe">Bauwerkstyp</dt> <dd class="svelte-1nmltxe"> </dd> <dt class="svelte-1nmltxe">Überbau Material</dt> <dd class="svelte-1nmltxe"> </dd> <dt class="svelte-1nmltxe">Unterbau Material</dt> <dd class="svelte-1nmltxe"> </dd> <!></dl></section> <section class="detail-section svelte-1nmltxe"><h4 class="svelte-1nmltxe">Lagerpositionen</h4> <dl class="svelte-1nmltxe"><dt class="svelte-1nmltxe">Allseitig beweglich</dt> <dd class="svelte-1nmltxe"> </dd> <dt class="svelte-1nmltxe">Einseitig geführt</dt> <dd class="svelte-1nmltxe"> </dd> <dt class="svelte-1nmltxe">Allseitig fest</dt> <dd class="svelte-1nmltxe"> </dd> <!> <!></dl></section> <section class="detail-section full-width svelte-1nmltxe"><h4 class="svelte-1nmltxe">Angefragte Hersteller</h4> <div class="manufacturer-chips svelte-1nmltxe"></div></section> <!></div>');function Vd(r,e){we(e,!1);let t=E(e,"open",12,!1),s=E(e,"request",8,null);function n(o){return new Date(o).toLocaleDateString("de-DE",{year:"numeric",month:"long",day:"numeric",hour:"2-digit",minute:"2-digit"})}function i(o){return Kn.filter(l=>o[l.id]).map(l=>l.name)}Re();const a=ae(()=>{var o;return((o=s())==null?void 0:o.data.projectName)||"Anfrage Details"});Gn(r,{get modalHeading(){return c(a)},passiveModal:!0,size:"lg",get open(){return t()},set open(o){t(o)},children:(o,l)=>{var u=ze(),m=q(u);{var p=d=>{var _=Bd(),y=f(_),C=g(f(y),2),I=g(f(C),2),w=f(I,!0);h(I);var S=g(I,4),M=f(S,!0);h(S),h(C),h(y);var O=g(y,2),b=g(f(O),2),j=g(f(b),2),V=f(j,!0);h(j);var H=g(j,4),A=f(H,!0);h(H);var k=g(H,4),B=f(k,!0);h(k);var U=g(k,4),F=f(U,!0);h(U),h(b),h(O);var L=g(O,2),x=g(f(L),2),z=g(f(x),2),fe=f(z,!0);h(z);var ye=g(z,4),J=f(ye,!0);h(ye);var re=g(ye,4),le=f(re,!0);h(re);var de=g(re,4),X=f(de,!0);h(de);var ve=g(de,4),Te=f(ve);h(ve);var Pe=g(ve,4),pe=f(Pe,!0);h(Pe);var xe=g(Pe,4),_e=f(xe,!0);h(xe);var Fe=g(xe,2);{var ue=Y=>{var Ee=Dd(),Ce=g(q(Ee),2),Me=f(Ce,!0);h(Ce),R(()=>P(Me,s().data.deliveryDate)),v(Y,Ee)};N(Fe,Y=>{s().data.deliveryDate&&Y(ue)})}h(x),h(L);var se=g(L,2),Ne=g(f(se),2),We=g(f(Ne),2),tt=f(We,!0);h(We);var rt=g(We,4),Ht=f(rt,!0);h(rt);var Oe=g(rt,4),ht=f(Oe,!0);h(Oe);var D=g(Oe,2);{var Z=Y=>{var Ee=Nd(),Ce=g(q(Ee),2),Me=f(Ce);h(Ce),R(()=>P(Me,`${s().data.guideBearingCount??""} (Vyd: ${s().data.guideBearingVyd??""} kN)`)),v(Y,Ee)};N(D,Y=>{s().data.guideBearingCount>0&&Y(Z)})}var ge=g(D,2);{var Ue=Y=>{var Ee=Ld(),Ce=g(q(Ee),2),Me=f(Ce);h(Ce),R(()=>P(Me,`${s().data.fixedPointCount??""} (Vxd: ${s().data.fixedPointVxd??""} kN, Vyd: ${s().data.fixedPointVyd??""} kN)`)),v(Y,Ee)};N(ge,Y=>{s().data.fixedPointCount>0&&Y(Ue)})}h(Ne),h(se);var He=g(se,2),je=g(f(He),2);At(je,5,()=>i(s().data.manufacturers),Lt,(Y,Ee)=>{var Ce=Ud(),Me=f(Ce,!0);h(Ce),R(()=>P(Me,c(Ee))),v(Y,Ce)}),h(je),h(He);var ie=g(He,2);{var me=Y=>{var Ee=Hd(),Ce=g(f(Ee),2),Me=f(Ce,!0);h(Ce),h(Ee),R(()=>P(Me,s().data.additionalNotes)),v(Y,Ee)};N(ie,Y=>{s().data.additionalNotes&&Y(me)})}h(_),R(Y=>{P(w,s().id),P(M,Y),P(V,s().data.name),P(A,s().data.email),P(B,s().data.company),P(F,s().data.role),P(fe,s().data.projectName),P(J,s().data.postalCode),P(le,s().data.projectPhase),P(X,s().data.requestType),P(Te,`${s().data.structureType??""}${s().data.structureSubtype?` - ${s().data.structureSubtype}`:""}`),P(pe,s().data.superstructureMaterial),P(_e,s().data.substructureMaterial),P(tt,s().data.movableAllDirections),P(Ht,s().data.laterallyFixed),P(ht,s().data.fixedAllDirections)},[()=>n(s().createdAt)],ae),v(d,_)};N(m,d=>{s()&&d(p)})}v(o,u)},$$slots:{default:!0},$$legacy:!0}),Ie()}var zd=T('<h1 class="page-title svelte-11vrnrd">Meine Anfragen</h1> <p class="page-subtitle svelte-11vrnrd">Verwalten Sie Ihre Herstelleranfragen</p>',1),Fd=T('<button class="request-link svelte-11vrnrd"> </button>'),Wd=T('<div class="empty-state svelte-11vrnrd"><p class="svelte-11vrnrd">Noch keine Anfragen vorhanden.</p> <p class="empty-hint svelte-11vrnrd">Erstellen Sie eine neue Herstelleranfrage über das Brückenlager-Tool.</p></div>'),jd=T('<div class="stats-row svelte-11vrnrd"><div class="stat-item svelte-11vrnrd"><span class="stat-value svelte-11vrnrd"> </span> <span class="stat-label svelte-11vrnrd">Gesamt</span></div> <div class="stat-item svelte-11vrnrd"><span class="stat-value svelte-11vrnrd"> </span> <span class="stat-label svelte-11vrnrd">Gesendet</span></div></div>'),qd=T("<!> <!> <!>",1),Gd=T("<!> <!>",1);function Kd(r,e){we(e,!1);const[t,s]=qn(),n=()=>jn(Zn,"$bridgeRequestStore",t),i=te();let a=te(null),o=te(!1);const l=[{key:"id",value:"Anfrage-ID"},{key:"projectName",value:"Projekt"},{key:"company",value:"Firma"},{key:"structureType",value:"Bauwerkstyp"},{key:"date",value:"Datum"},{key:"status",value:"Status"}];function u(C){return new Date(C).toLocaleDateString("de-DE",{year:"numeric",month:"2-digit",day:"2-digit"})}function m(C){switch(C){case"Gesendet":return"green";case"Entwurf":return"gray";default:return"gray"}}function p(C){$(a,n().find(I=>I.id===C)||null),c(a)&&$(o,!0)}ne(()=>n(),()=>{$(i,n().map(C=>({id:C.id,projectName:C.data.projectName||"-",company:C.data.company||"-",structureType:C.data.structureType||"-",date:u(C.createdAt),status:"Gesendet"})))}),De(),Re();var d=Gd(),_=q(d);Et(_,{backLabel:"",actionLabel:"Neue Anfrage",children:(C,I)=>{var w=qd(),S=q(w);Se(S,{children:(b,j)=>{ee(b,{lg:16,children:(V,H)=>{var A=zd();W(2),v(V,A)},$$slots:{default:!0}})},$$slots:{default:!0}});var M=g(S,2);Se(M,{children:(b,j)=>{ee(b,{children:(V,H)=>{var A=ze(),k=q(A);{var B=F=>{Hs(F,{get headers(){return l},get rows(){return c(i)},$$slots:{cell:(L,x)=>{const z=ae(()=>x.cell),fe=ae(()=>x.row);var ye=ze(),J=q(ye);{var re=de=>{const X=ae(()=>m(c(z).value));Zt(de,{get type(){return c(X)},children:(ve,Te)=>{W();var Pe=ce();R(()=>P(Pe,c(z).value)),v(ve,Pe)},$$slots:{default:!0}})},le=(de,X)=>{{var ve=Pe=>{var pe=Fd(),xe=f(pe);h(pe),R(_e=>P(xe,`${_e??""}...`),[()=>c(z).value.substring(0,8)],ae),oe("click",pe,()=>p(c(fe).id)),v(Pe,pe)},Te=Pe=>{var pe=ce();R(()=>P(pe,c(z).value)),v(Pe,pe)};N(de,Pe=>{c(z).key==="id"?Pe(ve):Pe(Te,!1)},X)}};N(J,de=>{c(z).key==="status"?de(re):de(le,!1)})}v(L,ye)}}})},U=F=>{var L=Wd();v(F,L)};N(k,F=>{c(i).length>0?F(B):F(U,!1)})}v(V,A)},$$slots:{default:!0}})},$$slots:{default:!0}});var O=g(M,2);Se(O,{children:(b,j)=>{ee(b,{children:(V,H)=>{var A=jd(),k=f(A),B=f(k),U=f(B,!0);h(B),W(2),h(k);var F=g(k,2),L=f(F),x=f(L,!0);h(L),W(2),h(F),h(A),R(()=>{P(U,n().length),P(x,n().length)}),v(V,A)},$$slots:{default:!0}})},$$slots:{default:!0}}),v(C,w)},$$slots:{default:!0}});var y=g(_,2);Vd(y,{get request(){return c(a)},get open(){return c(o)},set open(C){$(o,C)},$$legacy:!0}),v(r,d),Ie(),s()}var Yd=T('<h1 class="page-title svelte-16epnr2">My Quotes</h1> <p class="page-subtitle svelte-16epnr2">Manage and track your quotations</p>',1),Jd=T('<p class="summary-value svelte-16epnr2">$66,450</p> <p class="summary-label svelte-16epnr2">Total Quoted Value</p>',1),Zd=T('<p class="summary-value svelte-16epnr2">2</p> <p class="summary-label svelte-16epnr2">Active Quotes</p>',1),Qd=T('<p class="summary-value svelte-16epnr2">45%</p> <p class="summary-label svelte-16epnr2">Acceptance Rate</p>',1),Xd=T('<p class="summary-value svelte-16epnr2">7 days</p> <p class="summary-label svelte-16epnr2">Avg. Response Time</p>',1),eu=T("<!> <!> <!> <!>",1),tu=T('<a href="#" class="quote-link svelte-16epnr2"> </a>'),ru=T("<strong> </strong>"),su=T("<!> <!> <!>",1);function nu(r){const e=[{id:"QT-2023-001",customer:"LUMBER COMPANY",total:"$12,450.00",items:8,date:"2023-06-20",expires:"2023-07-20",status:"Active"},{id:"QT-2023-002",customer:"TIMBER DEPOT",total:"$8,320.00",items:5,date:"2023-06-18",expires:"2023-07-18",status:"Active"},{id:"QT-2023-003",customer:"WOODWORKS INC",total:"$24,100.00",items:12,date:"2023-06-15",expires:"2023-07-15",status:"Accepted"},{id:"QT-2023-004",customer:"FOREST SUPPLIES",total:"$5,680.00",items:3,date:"2023-06-10",expires:"2023-07-10",status:"Expired"},{id:"QT-2023-005",customer:"PINE TRADERS",total:"$15,900.00",items:7,date:"2023-06-08",expires:"2023-07-08",status:"Declined"}],t=[{key:"id",value:"Quote #"},{key:"customer",value:"Customer"},{key:"items",value:"Items"},{key:"total",value:"Total"},{key:"date",value:"Created"},{key:"expires",value:"Expires"},{key:"status",value:"Status"}];function s(n){switch(n){case"Active":return"blue";case"Accepted":return"green";case"Expired":return"gray";case"Declined":return"red";default:return"gray"}}Et(r,{backLabel:"",actionLabel:"Create Quote",children:(n,i)=>{var a=su(),o=q(a);Se(o,{children:(m,p)=>{ee(m,{lg:16,children:(d,_)=>{var y=Yd();W(2),v(d,y)},$$slots:{default:!0}})},$$slots:{default:!0}});var l=g(o,2);Se(l,{children:(m,p)=>{var d=eu(),_=q(d);ee(_,{lg:4,md:4,sm:4,children:(w,S)=>{Le(w,{class:"summary-tile",children:(M,O)=>{var b=Jd();W(2),v(M,b)},$$slots:{default:!0}})},$$slots:{default:!0}});var y=g(_,2);ee(y,{lg:4,md:4,sm:4,children:(w,S)=>{Le(w,{class:"summary-tile",children:(M,O)=>{var b=Zd();W(2),v(M,b)},$$slots:{default:!0}})},$$slots:{default:!0}});var C=g(y,2);ee(C,{lg:4,md:4,sm:4,children:(w,S)=>{Le(w,{class:"summary-tile",children:(M,O)=>{var b=Qd();W(2),v(M,b)},$$slots:{default:!0}})},$$slots:{default:!0}});var I=g(C,2);ee(I,{lg:4,md:4,sm:4,children:(w,S)=>{Le(w,{class:"summary-tile",children:(M,O)=>{var b=Xd();W(2),v(M,b)},$$slots:{default:!0}})},$$slots:{default:!0}}),v(m,d)},$$slots:{default:!0}});var u=g(l,2);Se(u,{children:(m,p)=>{ee(m,{children:(d,_)=>{Hs(d,{get headers(){return t},get rows(){return e},$$slots:{cell:(y,C)=>{const I=ae(()=>C.cell);var w=ze(),S=q(w);{var M=b=>{const j=ae(()=>s(c(I).value));Zt(b,{get type(){return c(j)},children:(V,H)=>{W();var A=ce();R(()=>P(A,c(I).value)),v(V,A)},$$slots:{default:!0}})},O=(b,j)=>{{var V=A=>{var k=tu(),B=f(k,!0);h(k),R(()=>P(B,c(I).value)),v(A,k)},H=(A,k)=>{{var B=F=>{var L=ru(),x=f(L,!0);h(L),R(()=>P(x,c(I).value)),v(F,L)},U=F=>{var L=ce();R(()=>P(L,c(I).value)),v(F,L)};N(A,F=>{c(I).key==="total"?F(B):F(U,!1)},k)}};N(b,A=>{c(I).key==="id"?A(V):A(H,!1)},j)}};N(S,b=>{c(I).key==="status"?b(M):b(O,!1)})}v(y,w)}}})},$$slots:{default:!0}})},$$slots:{default:!0}}),v(n,a)},$$slots:{default:!0}})}var iu=ke("<title> </title>"),au=ke('<svg><!><circle cx="22" cy="24" r="2"></circle><path fill="none" d="M22,28a4,4,0,1,1,4-4A4.0039,4.0039,0,0,1,22,28Zm0-6a2,2,0,1,0,2,2A2.0027,2.0027,0,0,0,22,22Z"></path><path d="M29.7769,23.4785A8.64,8.64,0,0,0,22,18a8.64,8.64,0,0,0-7.7769,5.4785L14,24l.2231.5215A8.64,8.64,0,0,0,22,30a8.64,8.64,0,0,0,7.7769-5.4785L30,24ZM22,28a4,4,0,1,1,4-4A4.0045,4.0045,0,0,1,22,28Z"></path><path d="M12,28H8V4h8v6a2.0058,2.0058,0,0,0,2,2h6v4h2V10a.9092.9092,0,0,0-.3-.7l-7-7A.9087.9087,0,0,0,18,2H8A2.0058,2.0058,0,0,0,6,4V28a2.0058,2.0058,0,0,0,2,2h4ZM18,4.4,23.6,10H18Z"></path></svg>');function ou(r,e){const t=Q(e,["children","$$slots","$$events","$$legacy"]),s=Q(t,["size","title"]);we(e,!1);const n=te(),i=te();let a=E(e,"size",8,16),o=E(e,"title",8,void 0);ne(()=>(K(t),K(o())),()=>{$(n,t["aria-label"]||t["aria-labelledby"]||o())}),ne(()=>(c(n),K(t)),()=>{$(i,{"aria-hidden":c(n)?void 0:!0,role:c(n)?"img":void 0,focusable:Number(t.tabindex)===0?!0:void 0})}),De(),Re();var l=au();$e(l,()=>({xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 32 32",fill:"currentColor",preserveAspectRatio:"xMidYMid meet",width:a(),height:a(),...c(i),...s}));var u=f(l);{var m=p=>{var d=iu(),_=f(d,!0);h(d),R(()=>P(_,o())),v(p,d)};N(u,p=>{o()&&p(m)})}W(4),h(l),v(r,l),Ie()}var lu=ke("<title> </title>"),cu=ke('<svg><!><path d="M2 28H30V30H2zM17.21 5.23l1.39.38 1 11.29 5.87 1.57A2 2 0 0127 20.62a1.88 1.88 0 01-1.37 1.52 2 2 0 01-1 0l-18.7-5a1.89 1.89 0 01-1.33-2.3L6.35 8.34l1.44.38L8.4 13.9l6 1.62L17.21 5.23m-1-2.2a1 1 0 00-.68.69L13 13.07l-2.81-.75L9.69 7.79A1 1 0 009 7L5.87 6.14a.94.94 0 00-.5 0 1 1 0 00-.68.68l-2 7.49a3.87 3.87 0 002.74 4.74l18.71 5A3.87 3.87 0 0029 21a4 4 0 00-3-4.42l-4.52-1.21L20.53 4.71a1 1 0 00-.72-.85L16.73 3a1.06 1.06 0 00-.5 0z"></path></svg>');function du(r,e){const t=Q(e,["children","$$slots","$$events","$$legacy"]),s=Q(t,["size","title"]);we(e,!1);const n=te(),i=te();let a=E(e,"size",8,16),o=E(e,"title",8,void 0);ne(()=>(K(t),K(o())),()=>{$(n,t["aria-label"]||t["aria-labelledby"]||o())}),ne(()=>(c(n),K(t)),()=>{$(i,{"aria-hidden":c(n)?void 0:!0,role:c(n)?"img":void 0,focusable:Number(t.tabindex)===0?!0:void 0})}),De(),Re();var l=cu();$e(l,()=>({xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 32 32",fill:"currentColor",preserveAspectRatio:"xMidYMid meet",width:a(),height:a(),...c(i),...s}));var u=f(l);{var m=p=>{var d=lu(),_=f(d,!0);h(d),R(()=>P(_,o())),v(p,d)};N(u,p=>{o()&&p(m)})}W(),h(l),v(r,l),Ie()}var uu=T('<div class="timeline-line svelte-1x7wtir"></div>'),hu=T('<div class="timeline-step svelte-1x7wtir"><p class="step-label svelte-1x7wtir"> </p> <div><!></div> <p class="step-date svelte-1x7wtir"> </p></div> <!>',1),fu=T('<div class="timeline-wrapper svelte-1x7wtir"><div class="timeline-container svelte-1x7wtir"></div></div>');function vu(r,e){we(e,!0);var t=fu(),s=f(t);At(s,21,()=>e.steps,Lt,(n,i,a)=>{var o=hu(),l=q(o),u=f(l),m=f(u,!0);h(u);var p=g(u,2);let d;var _=f(p);dr(_,()=>c(i).icon,(S,M)=>{M(S,{size:24,fill:"white"})}),h(p);var y=g(p,2),C=f(y,!0);h(y),h(l);var I=g(l,2);{var w=S=>{var M=uu();v(S,M)};N(I,S=>{a<e.steps.length-1&&S(w)})}R(S=>{P(m,c(i).label),d=Ae(p,1,"icon-box svelte-1x7wtir",null,d,S),P(C,c(i).date)},[()=>({active:c(i).active!==!1})]),v(n,o)}),h(s),h(t),v(r,t),Ie()}var pu=T('<div class="field svelte-y39ibg"><p class="label svelte-y39ibg">Ship-To</p> <p class="value svelte-y39ibg"> </p></div> <div class="field svelte-y39ibg"><p class="label svelte-y39ibg">Sales Order #</p> <p class="value svelte-y39ibg"> </p></div>',1),gu=T('<div class="field svelte-y39ibg"><p class="label svelte-y39ibg">Status</p> <p class="value status-complete svelte-y39ibg"><span class="dot">●</span> </p></div> <div class="field svelte-y39ibg"><p class="label svelte-y39ibg">Account Manager</p> <p class="value svelte-y39ibg"> </p></div>',1),mu=T('<div class="field svelte-y39ibg"><p class="label svelte-y39ibg">Customer PO#</p> <p class="value svelte-y39ibg"> </p></div> <div class="field svelte-y39ibg"><p class="label svelte-y39ibg">Linked Purchase Order #</p> <p class="value svelte-y39ibg"> </p></div>',1),_u=T('<div class="field svelte-y39ibg"><p class="label svelte-y39ibg">Payment Terms</p> <p class="value svelte-y39ibg"> </p></div> <div class="field svelte-y39ibg"><p class="label svelte-y39ibg">Ship Terms</p> <p class="value svelte-y39ibg"> </p></div>',1),bu=T('<div class="field svelte-y39ibg"><p class="label svelte-y39ibg">Amount</p> <p class="value svelte-y39ibg">Total Sales <span class="highlight svelte-y39ibg"> </span> <br/>Value:</p></div> <div class="field svelte-y39ibg"><p class="label svelte-y39ibg">Paid in Full</p> <p class="value svelte-y39ibg"> </p></div>',1),yu=T("<!> <!> <!> <!> <!>",1),wu=T('<p class="label svelte-y39ibg">Port of Loading</p> <p class="value uppercase svelte-y39ibg"> </p>',1),Iu=T('<p class="label svelte-y39ibg">Shipping Line</p> <p class="value uppercase svelte-y39ibg"> </p>',1),Eu=T('<p class="label svelte-y39ibg">Equipment No(s)</p> <p class="value svelte-y39ibg"> </p>',1),Tu=T('<p class="label svelte-y39ibg">BL/Waybill No</p> <p class="value svelte-y39ibg"> </p>',1),Pu=T("<!> <!> <!> <!>",1),xu=T('<div class="card-section header-section svelte-y39ibg"><p class="label svelte-y39ibg">Customer</p> <h3> </h3></div> <hr class="divider svelte-y39ibg"/> <div class="card-section details-grid svelte-y39ibg"><!></div> <hr class="divider svelte-y39ibg"/> <!> <hr class="divider svelte-y39ibg"/> <div class="card-section footer-info svelte-y39ibg"><!></div>',1);function ku(r,e){we(e,!0);const t=Ns(()=>[{label:"Order Placed",date:e.order.timeline.orderPlaced,icon:ou,active:!0},{label:"ETS",date:e.order.timeline.ets,icon:zs,active:!0},{label:"ETA",date:e.order.timeline.eta,icon:du,active:!0}]);Le(r,{class:"order-card",children:(s,n)=>{var i=xu(),a=q(i),o=g(f(a),2),l=f(o,!0);h(o),h(a);var u=g(a,4),m=f(u);ts(m,{fullWidth:!0,padding:!0,children:(y,C)=>{Se(y,{children:(I,w)=>{var S=yu(),M=q(S);ee(M,{sm:4,md:2,lg:3,children:(H,A)=>{var k=pu(),B=q(k),U=g(f(B),2),F=f(U,!0);h(U),h(B);var L=g(B,2),x=g(f(L),2),z=f(x,!0);h(x),h(L),R(()=>{P(F,e.order.shipTo),P(z,e.order.salesOrderNumber)}),v(H,k)},$$slots:{default:!0}});var O=g(M,2);ee(O,{sm:4,md:2,lg:3,children:(H,A)=>{var k=gu(),B=q(k),U=g(f(B),2),F=g(f(U));h(U),h(B);var L=g(B,2),x=g(f(L),2),z=f(x,!0);h(x),h(L),R(()=>{P(F,` ${e.order.status??""}`),P(z,e.order.accountManager)}),v(H,k)},$$slots:{default:!0}});var b=g(O,2);ee(b,{sm:4,md:2,lg:3,children:(H,A)=>{var k=mu(),B=q(k),U=g(f(B),2),F=f(U,!0);h(U),h(B);var L=g(B,2),x=g(f(L),2),z=f(x,!0);h(x),h(L),R(()=>{P(F,e.order.customerPO),P(z,e.order.linkedPurchaseOrder||"—")}),v(H,k)},$$slots:{default:!0}});var j=g(b,2);ee(j,{sm:4,md:2,lg:3,children:(H,A)=>{var k=_u(),B=q(k),U=g(f(B),2),F=f(U,!0);h(U),h(B);var L=g(B,2),x=g(f(L),2),z=f(x,!0);h(x),h(L),R(()=>{P(F,e.order.paymentTerms),P(z,e.order.shipTerms)}),v(H,k)},$$slots:{default:!0}});var V=g(j,2);ee(V,{sm:4,md:2,lg:4,children:(H,A)=>{var k=bu(),B=q(k),U=g(f(B),2),F=g(f(U)),L=f(F,!0);h(F),W(3),h(U),h(B);var x=g(B,2),z=g(f(x),2),fe=f(z,!0);h(z),h(x),R(()=>{P(L,e.order.totalSales),P(fe,e.order.paidInFull?"Yes":"No")}),v(H,k)},$$slots:{default:!0}}),v(I,S)},$$slots:{default:!0}})},$$slots:{default:!0}}),h(u);var p=g(u,4);vu(p,{get steps(){return c(t)}});var d=g(p,4),_=f(d);ts(_,{fullWidth:!0,padding:!0,children:(y,C)=>{Se(y,{children:(I,w)=>{var S=Pu(),M=q(S);ee(M,{sm:4,md:2,lg:3,children:(V,H)=>{var A=wu(),k=g(q(A),2),B=f(k,!0);h(k),R(()=>P(B,e.order.portOfLoading)),v(V,A)},$$slots:{default:!0}});var O=g(M,2);ee(O,{sm:4,md:3,lg:4,children:(V,H)=>{var A=Iu(),k=g(q(A),2),B=f(k,!0);h(k),R(()=>P(B,e.order.shippingLine)),v(V,A)},$$slots:{default:!0}});var b=g(O,2);ee(b,{sm:4,md:2,lg:3,children:(V,H)=>{var A=Eu(),k=g(q(A),2),B=f(k,!0);h(k),R(()=>P(B,e.order.equipmentNumbers||"—")),v(V,A)},$$slots:{default:!0}});var j=g(b,2);ee(j,{sm:4,md:2,lg:2,children:(V,H)=>{var A=Tu(),k=g(q(A),2),B=f(k,!0);h(k),R(()=>P(B,e.order.blWaybillNo||"—")),v(V,A)},$$slots:{default:!0}}),v(I,S)},$$slots:{default:!0}})},$$slots:{default:!0}}),h(d),R(()=>P(l,e.order.customer)),v(s,i)},$$slots:{default:!0}}),Ie()}function Au(r){const e={customer:"LUMBER COMPANY",shipTo:"TIMBER DEPOT",salesOrderNumber:"27041941",status:"Complete",accountManager:"Joseph Campbell",customerPO:"23008223",linkedPurchaseOrder:"",paymentTerms:"1% 75 DAYS N76 ADI/ADF",shipTerms:"CIP - CASTRIES",totalSales:"$64,855.10",paidInFull:!1,portOfLoading:"MOBILE",shippingLine:"OSLO CARIBBEAN CARRIERS",equipmentNumbers:"",blWaybillNo:"",timeline:{orderPlaced:"21 Jun 2023",ets:"25 Aug 2023",eta:"27 Jul 2023"}};Et(r,{backLabel:"BACK",actionLabel:"FOLLOW ORDER",children:(t,s)=>{Se(t,{children:(n,i)=>{ee(n,{children:(a,o)=>{ku(a,{get order(){return e}})},$$slots:{default:!0}})},$$slots:{default:!0}})},$$slots:{default:!0}})}var Su=T('<h1 class="page-title svelte-19wt0gl">My Products</h1> <p class="page-subtitle svelte-19wt0gl">Manage your product inventory</p>',1),Cu=T('<div class="product-image svelte-19wt0gl"><span class="product-icon svelte-19wt0gl">🪵</span></div> <div class="product-info svelte-19wt0gl"><h4 class="product-name svelte-19wt0gl"> </h4> <p class="product-category svelte-19wt0gl"> </p> <div class="product-details svelte-19wt0gl"><span class="product-price svelte-19wt0gl"> </span> <!></div> <p class="product-stock svelte-19wt0gl"> </p> <div class="product-actions svelte-19wt0gl"><!> <!></div></div>',1),$u=T("<!> <!> <!>",1);function Ru(r){const e=[{id:"PRD-001",name:"Pine Lumber 2x4",category:"Lumber",price:"$4.50/pc",stock:1250,status:"In Stock"},{id:"PRD-002",name:"Oak Planks Premium",category:"Hardwood",price:"$12.00/sqft",stock:450,status:"In Stock"},{id:"PRD-003",name:"Cedar Shingles",category:"Roofing",price:"$2.25/pc",stock:3200,status:"In Stock"},{id:"PRD-004",name:"Maple Flooring",category:"Flooring",price:"$8.75/sqft",stock:85,status:"Low Stock"},{id:"PRD-005",name:'Birch Plywood 3/4"',category:"Plywood",price:"$45.00/sheet",stock:0,status:"Out of Stock"},{id:"PRD-006",name:"Walnut Veneer",category:"Veneer",price:"$6.50/sqft",stock:620,status:"In Stock"}];function t(s){switch(s){case"In Stock":return"green";case"Low Stock":return"cyan";case"Out of Stock":return"red";default:return"gray"}}Et(r,{backLabel:"",actionLabel:"Add Product",children:(s,n)=>{var i=$u(),a=q(i);Se(a,{children:(u,m)=>{ee(u,{lg:16,children:(p,d)=>{var _=Su();W(2),v(p,_)},$$slots:{default:!0}})},$$slots:{default:!0}});var o=g(a,2);Se(o,{children:(u,m)=>{ee(u,{lg:8,children:(p,d)=>{Vr(p,{placeholder:"Search products..."})},$$slots:{default:!0}})},$$slots:{default:!0}});var l=g(o,2);Se(l,{children:(u,m)=>{var p=ze(),d=q(p);At(d,1,()=>e,Lt,(_,y)=>{ee(_,{lg:5,md:4,sm:4,children:(C,I)=>{Le(C,{class:"product-card",children:(w,S)=>{var M=Cu(),O=g(q(M),2),b=f(O),j=f(b,!0);h(b);var V=g(b,2),H=f(V,!0);h(V);var A=g(V,2),k=f(A),B=f(k,!0);h(k);var U=g(k,2);const F=ae(()=>t(c(y).status));Zt(U,{get type(){return c(F)},size:"sm",children:(J,re)=>{W();var le=ce();R(()=>P(le,c(y).status)),v(J,le)},$$slots:{default:!0}}),h(A);var L=g(A,2),x=f(L);h(L);var z=g(L,2),fe=f(z);st(fe,{kind:"ghost",size:"small",children:(J,re)=>{W();var le=ce("Edit");v(J,le)},$$slots:{default:!0}});var ye=g(fe,2);st(ye,{kind:"ghost",size:"small",children:(J,re)=>{W();var le=ce("View");v(J,le)},$$slots:{default:!0}}),h(z),h(O),R(()=>{P(j,c(y).name),P(H,c(y).category),P(B,c(y).price),P(x,`Stock: ${c(y).stock??""} units`)}),v(w,M)},$$slots:{default:!0}})},$$slots:{default:!0}})}),v(u,p)},$$slots:{default:!0}}),v(s,i)},$$slots:{default:!0}})}var Ou=T('<h1 class="page-title svelte-yyu2p6">Catalogue</h1> <p class="page-subtitle svelte-yyu2p6">Browse our complete product catalogue</p>',1),Mu=T("<!> <!>",1),Du=T('<div class="catalogue-header svelte-yyu2p6"><span class="results-count svelte-yyu2p6"> </span></div>'),Nu=T('<div class="catalogue-image svelte-yyu2p6"><span class="catalogue-icon svelte-yyu2p6">📦</span></div> <div class="catalogue-info svelte-yyu2p6"><!> <h4 class="catalogue-name svelte-yyu2p6"> </h4> <p class="catalogue-price svelte-yyu2p6"> </p> <div class="catalogue-meta svelte-yyu2p6"><p class="svelte-yyu2p6"> </p> <p class="svelte-yyu2p6"> </p></div> <div class="catalogue-actions svelte-yyu2p6"><!> <!></div></div>',1),Lu=T('<div class="pagination svelte-yyu2p6"><!> <span class="page-info svelte-yyu2p6">Page 1 of 3</span> <!></div>'),Uu=T("<!> <!> <!> <!> <!>",1);function Hu(r){const e=[{id:"all",text:"All Categories"},{id:"lumber",text:"Lumber"},{id:"hardwood",text:"Hardwood"},{id:"plywood",text:"Plywood"},{id:"flooring",text:"Flooring"},{id:"roofing",text:"Roofing"}],t=[{id:"CAT-001",name:"Douglas Fir 2x6",category:"Lumber",price:"$6.25/pc",minOrder:"100 pcs",leadTime:"3-5 days"},{id:"CAT-002",name:"White Oak Boards",category:"Hardwood",price:"$14.50/sqft",minOrder:"50 sqft",leadTime:"5-7 days"},{id:"CAT-003",name:"Baltic Birch Plywood",category:"Plywood",price:"$52.00/sheet",minOrder:"10 sheets",leadTime:"7-10 days"},{id:"CAT-004",name:"Brazilian Cherry Flooring",category:"Flooring",price:"$11.25/sqft",minOrder:"100 sqft",leadTime:"10-14 days"},{id:"CAT-005",name:"Western Red Cedar",category:"Lumber",price:"$8.75/pc",minOrder:"50 pcs",leadTime:"3-5 days"},{id:"CAT-006",name:"Ash Hardwood",category:"Hardwood",price:"$9.00/sqft",minOrder:"75 sqft",leadTime:"5-7 days"},{id:"CAT-007",name:"Marine Grade Plywood",category:"Plywood",price:"$68.00/sheet",minOrder:"5 sheets",leadTime:"7-10 days"},{id:"CAT-008",name:"Bamboo Flooring",category:"Flooring",price:"$7.50/sqft",minOrder:"150 sqft",leadTime:"7-10 days"}];let s=te("all");Et(r,{backLabel:"",actionLabel:"Request Quote",children:(n,i)=>{var a=Uu(),o=q(a);Se(o,{children:(d,_)=>{ee(d,{lg:16,children:(y,C)=>{var I=Ou();W(2),v(y,I)},$$slots:{default:!0}})},$$slots:{default:!0}});var l=g(o,2);Se(l,{children:(d,_)=>{var y=Mu(),C=q(y);ee(C,{lg:8,md:4,sm:4,children:(w,S)=>{Vr(w,{placeholder:"Search catalogue..."})},$$slots:{default:!0}});var I=g(C,2);ee(I,{lg:4,md:4,sm:4,children:(w,S)=>{_i(w,{titleText:"",get items(){return e},get selectedId(){return c(s)},set selectedId(M){$(s,M)},$$legacy:!0})},$$slots:{default:!0}}),v(d,y)},$$slots:{default:!0}});var u=g(l,2);Se(u,{children:(d,_)=>{ee(d,{lg:16,children:(y,C)=>{var I=Du(),w=f(I),S=f(w);h(w),h(I),R(()=>P(S,`${t.length??""} products found`)),v(y,I)},$$slots:{default:!0}})},$$slots:{default:!0}});var m=g(u,2);Se(m,{children:(d,_)=>{var y=ze(),C=q(y);At(C,1,()=>t,Lt,(I,w)=>{ee(I,{lg:4,md:4,sm:4,children:(S,M)=>{Le(S,{class:"catalogue-card",children:(O,b)=>{var j=Nu(),V=g(q(j),2),H=f(V);Zt(H,{type:"outline",size:"sm",children:(le,de)=>{W();var X=ce();R(()=>P(X,c(w).category)),v(le,X)},$$slots:{default:!0}});var A=g(H,2),k=f(A,!0);h(A);var B=g(A,2),U=f(B,!0);h(B);var F=g(B,2),L=f(F),x=f(L);h(L);var z=g(L,2),fe=f(z);h(z),h(F);var ye=g(F,2),J=f(ye);st(J,{kind:"primary",size:"small",children:(le,de)=>{W();var X=ce("Add to Quote");v(le,X)},$$slots:{default:!0}});var re=g(J,2);st(re,{kind:"ghost",size:"small",children:(le,de)=>{W();var X=ce("Details");v(le,X)},$$slots:{default:!0}}),h(ye),h(V),R(()=>{P(k,c(w).name),P(U,c(w).price),P(x,`Min: ${c(w).minOrder??""}`),P(fe,`Lead: ${c(w).leadTime??""}`)}),v(O,j)},$$slots:{default:!0}})},$$slots:{default:!0}})}),v(d,y)},$$slots:{default:!0}});var p=g(m,2);Se(p,{children:(d,_)=>{ee(d,{children:(y,C)=>{var I=Lu(),w=f(I);st(w,{kind:"ghost",size:"small",disabled:!0,children:(M,O)=>{W();var b=ce("Previous");v(M,b)},$$slots:{default:!0}});var S=g(w,4);st(S,{kind:"ghost",size:"small",children:(M,O)=>{W();var b=ce("Next");v(M,b)},$$slots:{default:!0}}),h(I),v(y,I)},$$slots:{default:!0}})},$$slots:{default:!0}}),v(n,a)},$$slots:{default:!0}})}var Bu=T('<div class="form-content svelte-ibo97i"><!> <!> <!> <div class="links svelte-ibo97i"><!> <span class="separator svelte-ibo97i">|</span> <!></div></div>'),Vu=T('<div class="form-content svelte-ibo97i"><!> <!> <!> <!> <div class="links svelte-ibo97i"><!></div></div>'),zu=T('<div class="form-content svelte-ibo97i"><p class="reset-info svelte-ibo97i">Geben Sie Ihre E-Mail-Adresse ein und wir senden Ihnen einen Link zum Zurücksetzen Ihres Passworts.</p> <!> <!> <div class="links svelte-ibo97i"><!></div></div>'),Fu=T('<div class="login-container svelte-ibo97i" role="form"><div class="login-card svelte-ibo97i"><div class="login-header svelte-ibo97i"><h1 class="svelte-ibo97i">ElastoTool</h1> <p class="subtitle svelte-ibo97i"><!></p></div> <!> <!> <!></div></div>');function Wu(r,e){we(e,!0);let t=qe("login"),s=qe(""),n=qe(""),i=qe(""),a=qe(!1),o=qe(""),l=qe("");function u(){$(o,""),$(l,"")}function m(){$(s,""),$(n,""),$(i,""),u()}function p(x){$(t,x,!0),m()}async function d(){if(u(),!c(s)||!c(n)){$(o,"Bitte füllen Sie alle Felder aus.");return}$(a,!0);try{await Ql(qt,c(s),c(n))}catch(x){$(o,C(x.code),!0)}finally{$(a,!1)}}async function _(){if(u(),!c(s)||!c(n)||!c(i)){$(o,"Bitte füllen Sie alle Felder aus.");return}if(c(n)!==c(i)){$(o,"Die Passwörter stimmen nicht überein.");return}if(c(n).length<6){$(o,"Das Passwort muss mindestens 6 Zeichen lang sein.");return}$(a,!0);try{await Zl(qt,c(s),c(n))}catch(x){$(o,C(x.code),!0)}finally{$(a,!1)}}async function y(){if(u(),!c(s)){$(o,"Bitte geben Sie Ihre E-Mail-Adresse ein.");return}$(a,!0);try{await Jl(qt,c(s)),$(l,"Eine E-Mail zum Zurücksetzen des Passworts wurde gesendet. Bitte überprüfen Sie Ihren Posteingang.")}catch(x){$(o,C(x.code),!0)}finally{$(a,!1)}}function C(x){switch(x){case"auth/invalid-email":return"Ungültige E-Mail-Adresse.";case"auth/user-disabled":return"Dieses Benutzerkonto wurde deaktiviert.";case"auth/user-not-found":return"Kein Benutzer mit dieser E-Mail-Adresse gefunden.";case"auth/wrong-password":return"Falsches Passwort.";case"auth/invalid-credential":return"Ungültige Anmeldedaten. Bitte überprüfen Sie Ihre E-Mail und Ihr Passwort.";case"auth/email-already-in-use":return"Diese E-Mail-Adresse wird bereits verwendet.";case"auth/weak-password":return"Das Passwort ist zu schwach. Bitte wählen Sie ein stärkeres Passwort.";case"auth/too-many-requests":return"Zu viele Anmeldeversuche. Bitte versuchen Sie es später erneut.";case"auth/network-request-failed":return"Netzwerkfehler. Bitte überprüfen Sie Ihre Internetverbindung.";default:return"Ein Fehler ist aufgetreten. Bitte versuchen Sie es erneut."}}function I(x){x.key==="Enter"&&(c(t)==="login"?d():c(t)==="register"?_():c(t)==="reset"&&y())}var w=Fu(),S=f(w),M=f(S),O=g(f(M),2),b=f(O);{var j=x=>{var z=ce("Melden Sie sich an, um fortzufahren");v(x,z)},V=(x,z)=>{{var fe=J=>{var re=ce("Erstellen Sie ein neues Konto");v(J,re)},ye=J=>{var re=ce("Passwort zurücksetzen");v(J,re)};N(x,J=>{c(t)==="register"?J(fe):J(ye,!1)},z)}};N(b,x=>{c(t)==="login"?x(j):x(V,!1)})}h(O),h(M);var H=g(M,2);{var A=x=>{rs(x,{kind:"error",title:"Fehler",get subtitle(){return c(o)},hideCloseButton:!0})};N(H,x=>{c(o)&&x(A)})}var k=g(H,2);{var B=x=>{rs(x,{kind:"success",title:"Erfolg",get subtitle(){return c(l)},hideCloseButton:!0})};N(k,x=>{c(l)&&x(B)})}var U=g(k,2);{var F=x=>{var z=Bu(),fe=f(z);Tr(fe,{labelText:"E-Mail-Adresse",placeholder:"ihre.email@beispiel.de",type:"email",get disabled(){return c(a)},get value(){return c(s)},set value(X){$(s,X,!0)}});var ye=g(fe,2);Pr(ye,{labelText:"Passwort",placeholder:"Passwort eingeben",get disabled(){return c(a)},get value(){return c(n)},set value(X){$(n,X,!0)}});var J=g(ye,2);st(J,{kind:"secondary",get disabled(){return c(a)},class:"submit-button",$$events:{click:d},children:(X,ve)=>{W();var Te=ce();R(()=>P(Te,c(a)?"Wird angemeldet...":"Anmelden")),v(X,Te)},$$slots:{default:!0}});var re=g(J,2),le=f(re);Bt(le,{$$events:{click:()=>p("reset")},children:(X,ve)=>{W();var Te=ce("Passwort vergessen?");v(X,Te)},$$slots:{default:!0}});var de=g(le,4);Bt(de,{$$events:{click:()=>p("register")},children:(X,ve)=>{W();var Te=ce("Konto erstellen");v(X,Te)},$$slots:{default:!0}}),h(re),h(z),v(x,z)},L=(x,z)=>{{var fe=J=>{var re=Vu(),le=f(re);Tr(le,{labelText:"E-Mail-Adresse",placeholder:"ihre.email@beispiel.de",type:"email",get disabled(){return c(a)},get value(){return c(s)},set value(pe){$(s,pe,!0)}});var de=g(le,2);Pr(de,{labelText:"Passwort",placeholder:"Passwort eingeben (min. 6 Zeichen)",get disabled(){return c(a)},get value(){return c(n)},set value(pe){$(n,pe,!0)}});var X=g(de,2);Pr(X,{labelText:"Passwort bestätigen",placeholder:"Passwort erneut eingeben",get disabled(){return c(a)},get value(){return c(i)},set value(pe){$(i,pe,!0)}});var ve=g(X,2);st(ve,{kind:"secondary",get disabled(){return c(a)},class:"submit-button",$$events:{click:_},children:(pe,xe)=>{W();var _e=ce();R(()=>P(_e,c(a)?"Wird registriert...":"Registrieren")),v(pe,_e)},$$slots:{default:!0}});var Te=g(ve,2),Pe=f(Te);Bt(Pe,{$$events:{click:()=>p("login")},children:(pe,xe)=>{W();var _e=ce("Bereits ein Konto? Anmelden");v(pe,_e)},$$slots:{default:!0}}),h(Te),h(re),v(J,re)},ye=(J,re)=>{{var le=de=>{var X=zu(),ve=g(f(X),2);Tr(ve,{labelText:"E-Mail-Adresse",placeholder:"ihre.email@beispiel.de",type:"email",get disabled(){return c(a)},get value(){return c(s)},set value(xe){$(s,xe,!0)}});var Te=g(ve,2);st(Te,{kind:"secondary",get disabled(){return c(a)},class:"submit-button",$$events:{click:y},children:(xe,_e)=>{W();var Fe=ce();R(()=>P(Fe,c(a)?"Wird gesendet...":"Link senden")),v(xe,Fe)},$$slots:{default:!0}});var Pe=g(Te,2),pe=f(Pe);Bt(pe,{$$events:{click:()=>p("login")},children:(xe,_e)=>{W();var Fe=ce("Zurück zur Anmeldung");v(xe,Fe)},$$slots:{default:!0}}),h(Pe),h(X),v(de,X)};N(J,de=>{c(t)==="reset"&&de(le)},re)}};N(x,J=>{c(t)==="register"?J(fe):J(ye,!1)},z)}};N(U,x=>{c(t)==="login"?x(F):x(L,!1)})}h(S),h(w),oe("keypress",w,I),v(r,w),Ie()}function ju(r){Et(r,{backLabel:"",actionLabel:"",children:(e,t)=>{Se(e,{children:(s,n)=>{ee(s,{lg:16,children:(i,a)=>{Wu(i,{})},$$slots:{default:!0}})},$$slots:{default:!0}})},$$slots:{default:!0}})}var qu=T('<div class="loading-container svelte-2g7l8z"><div class="loading-spinner svelte-2g7l8z"></div></div>'),Gu=T('<div class="dashboard-container svelte-2g7l8z"><div><!> <div class="content-area svelte-2g7l8z"><!></div></div></div>');function Ku(r,e){we(e,!0);let t=qe(!0),s=qe("dashboard"),n=qe(null),i=qe(!0);Ms(()=>{const I=tc(qt,w=>{$(n,w,!0),$(i,!1)});return()=>I()});function a(I){$(s,I,!0)}async function o(){await rc(qt)}var l=Gu(),u=f(l);let m;var p=f(u);da(p,{get activeItem(){return c(s)},onNavigate:a,get user(){return c(n)},onLogout:o,get isOpen(){return c(t)},set isOpen(I){$(t,I,!0)}});var d=g(p,2),_=f(d);{var y=I=>{var w=qu();v(I,w)},C=(I,w)=>{{var S=O=>{ju(O)},M=(O,b)=>{{var j=H=>{Os(H)},V=(H,A)=>{{var k=U=>{Md(U)},B=(U,F)=>{{var L=z=>{Kd(z,{})},x=(z,fe)=>{{var ye=re=>{nu(re)},J=(re,le)=>{{var de=ve=>{Au(ve)},X=(ve,Te)=>{{var Pe=xe=>{Ru(xe)},pe=(xe,_e)=>{{var Fe=se=>{Hu(se)},ue=se=>{Os(se)};N(xe,se=>{c(s)==="catalogue"?se(Fe):se(ue,!1)},_e)}};N(ve,xe=>{c(s)==="products"?xe(Pe):xe(pe,!1)},Te)}};N(re,ve=>{c(s)==="orders"?ve(de):ve(X,!1)},le)}};N(z,re=>{c(s)==="quotes"?re(ye):re(J,!1)},fe)}};N(U,z=>{c(s)==="requests"?z(L):z(x,!1)},F)}};N(H,U=>{c(s)==="chats"?U(k):U(B,!1)},A)}};N(O,H=>{c(s)==="dashboard"?H(j):H(V,!1)},b)}};N(I,O=>{c(n)?O(M,!1):O(S)},w)}};N(_,I=>{c(i)?I(y):I(C,!1)})}h(d),h(u),h(l),R(I=>m=Ae(u,1,"layout svelte-2g7l8z",null,m,I),[()=>({"sidebar-open":c(t)})]),v(r,l),Ie()}function ph(r){Ku(r,{})}export{ph as component,vh as universal};
